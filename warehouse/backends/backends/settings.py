...
SECRET_KEY = 'n5vfz73^%4y31xqyms6uk@%dsbdpam542t(qe$t47iqb^+qm1i'
...
# NOTE(xchu): need to set this to False, and add origin white-list on production.
...
REDIS = {
    ...
    'key_fmts': {
        ...
        'cell_key': 'phone',            # Winner cell key in result hash
    }
}
